    ...
    If txtNuevaContraseña = txtNuevaContraseña2 Then
      If EC_SHAREWARE Then
        Select Case frmEventControl.cboIdioma.ListIndex
          Case EC_ESPAÑOL
            MsgBox "Solamente puede cambiar la contraseña " & _
            "en la versión registrada de " & gstrPrograma, _
            vbInformation, "Cambiar Contraseña Información"
          Case EC_ENGLISH
          ...
          Case EC_CATALA
            ...
            "a la versió registrada de " & gstrPrograma, _
            vbInformation, "Cambiar Contrasenya Informació"
        End Select
      Else
        
        gdb.NewPassword gstrContraseña, txtNuevaContraseña
        gdbHistorial.NewPassword gstrContraseña, txtNuevaContraseña
...
Private Sub Form_Load()
  Select Case frmEventControl.cboIdioma.ListIndex
    ...
    Case EC_ENGLISH
      frmContraseñaCambiar.Caption = "Change Password"
      lblContraseña = "Password"
      lblNuevaContraseña.Caption = "New Password"
      lblNuevaContraseña2.Caption = "Re-entrer new Password"
      cmdAceptar.Caption = "&Accept"
      cmdCancelar.Caption = "&Cancel"
    Case EC_CATALA
      frmContraseñaCambiar.Caption = "Cambiar Contrasenya"
      lblContraseña = "Contrasenya"
      lblNuevaContraseña.Caption = "Nova Contrasenya"
      lblNuevaContraseña2.Caption = "Reentrar nova Contrasenya"
