...
Function GetWinFiles() As Variant
  ...
  GetWinFiles = arrFichero()
  
GetWinFiles_Err:

End Function

Public Sub ControlEventos(IsScrSavOn As Boolean, IsPrgOn() As Boolean)
  ...
  Do While gaPrograma(intPrograma, 1) <> ""
    intFichero = 0
    Do
      If UCase(arrFichero(intFichero)) = _
         UCase(gaPrograma(intPrograma, 1)) Then
